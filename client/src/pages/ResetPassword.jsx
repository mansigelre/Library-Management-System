...
const ResetPassword = () => {
  ...
  const {loading, error,user, isAuthenticated, message,} =useSelector(state => state.auth);
...
const handleResetPassword = (e) => {
  ...
  // Now dispatch only if passwords match
  ...
  <div className="flex flex-col justify-center md:flex-row h-screen ">
    ...
    <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col justify-center 
    items-center p-8 rounded-tr-[80px] rounded-br-[80px]">
      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        <form onSubmit={handleResetPassword}>
          <div className="mb-4">
             ...
             value={password} onChange={(e)=>setPassword(e.target.value)} placeholder="Enter Password" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none"/>
          </div>
          <div className="mb-4">
             <input type="password" required
             value={confirmPassword} onChange={(e)=>setConfirmPassword(e.target.value)} placeholder="Confirm Password" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none"/>
          </div>
