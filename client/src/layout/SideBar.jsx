...
//             dispatch(resetAuthSlice());
//           }
//         },[error, message, dispatch,loading,isAuthenticated])
...
//         <button className="w-full py-2 font-medium bg-transparent rounded-md hoverr:cursor-pointer flex items-center space-x-2" onClick={()=>setSelectedComponent("Dashboard")}>
//           <img src={dashboardIcon} alt="icon" /><span>Dashboard</span>
//         </button>

//         <button className="w-full py-2 font-medium bg-transparent rounded-md hoverr:cursor-pointer flex items-center space-x-2" onClick={()=>setSelectedComponent("Books")}>
//           <img src={bookIcon} alt="icon" /><span>Books</span>
//         </button>
//         {
//            isAuthenticated && user?.role==="Admin" &&(
//             <>
//             <button className="w-full py-2 font-medium bg-transparent rounded-md hoverr:cursor-pointer flex items-center space-x-2" onClick={()=>setSelectedComponent("Catalog")}>
//           <img src={catalogIcon} alt="icon" /><span>Catalog</span>
//         </button>
//         <button className="w-full py-2 font-medium bg-transparent rounded-md hoverr:cursor-pointer flex items-center space-x-2" onClick={()=>setSelectedComponent("Users")}>
//           <img src={usersIcon} alt="icon" /><span>Users</span>
//         </button>
//         <button className="w-full py-2 font-medium bg-transparent rounded-md hoverr:cursor-pointer flex items-center space-x-2"
