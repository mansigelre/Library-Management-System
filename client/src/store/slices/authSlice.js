...
export const resetPassword=(data,token)=> async (dispatch)=>{
    ...
    await axios.put(`http://localhost:4000/api/v1/auth/reset-password/${token}`,data,{
        withCredentials:true,
        headers:{
            "Content-Type":"application/json",
        },
        ...
        dispatch(authSlice.actions.resetPasswordSuccess({message: res.data.message}))
    }).catch((error)=>{
...
export const updatePassword=(data)=> async (dispatch)=>{
    ...
    await axios.put(`http://localhost:4000/api/v1/auth/update-password`,data,{
        withCredentials:true,
        headers:{
            "Content-Type":"application/json",
        },
