...
const Catalog = () => {
  ...
  const {
    userBorrowedBooks,allBorrowedBooks, loading,error,message } = useSelector
    (state => state.borrow);
              ...
              <tbody>
                {booksToDisplay.map((book, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">{formattedDate(book.dueDate)}</td>

                    <td className="px-4 py-2">{formattedDateAndTime(book.createdAt)}</td>
