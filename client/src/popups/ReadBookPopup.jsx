...
const ReadBookPopup = ({book}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="w-full bg-white rounded-lg shadow-lg sm:w-1/2 lg:w-1/2 2xl:w-1/3">
    ...
    <h2 className=" text-lg font-bold">View Book Info</h2>
      ...
      <div className="p-6">
        <div className="mb-4">
          <label className="block text-gray-700 font-semibold">Books Title</label>
      ...
      <div className="flex justify-end px-6 bg-gray-100 rounded-b-lg">
