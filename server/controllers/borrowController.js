...
export const recordBorrowedBook=catchAsyncErrors(async(req,res,next)=>{
    ...
    // agar book borrow ki thi or return krdi lekin dubara borrow krni hai to allowed hai
    // lekin agar book borrow ki hai or abhi tak return nhi ki to allowed nhi hai
    // ye check krna hai
